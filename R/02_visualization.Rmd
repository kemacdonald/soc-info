...
e1_plot <- cowplot::plot_grid(action_plot_e1, rt_plot, entropy_plot, labels = c("A", "B", "C"),
                                ncol = 1,
                                rel_heights = c(1, 1, 1))
```
...
```{r}
ggsave("e1_plot.png", plot = e1_plot, width = 6, height = 10,
...
e2_plot <- cowplot::plot_grid(data_mod_comp, e2_rt_plot, e2_ent_plot, phi, 
                                   labels = c("A", "B", "C", "D"), 
                                   label_x = 0.03,
                                   ncol = 1,
                                   rel_heights = c(1.3, 0.7,0.8, 1))
```

```{r}
ggsave("e2_plot.png", plot = e2_plot, width = 4.5, height = 10,
path = here::here("writing/cogsci2018/figs"))
```
