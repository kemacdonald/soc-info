...
d_cat <- read_csv(here("data/02_tidy_data/soc-info-cat-pilot1-tidy.csv"))
...
```{r}
d_cat %>% distinct(id, complete_time_min) %>% pull(complete_time_min) %>% mean()
```

### Toy choice plot

Plot the porportion of participants choosing each toy type (activation, presentation, learning) as a function of the goal and social conditions.
