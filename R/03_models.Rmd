...
d_cat <- read_csv("data/02_tidy_data/soc-info-cat-pilot2-tidy.csv")
```
...
Fit multinomial model. From McElreath's Statistical Rethinking book:
...
e3_m <- brm(data = d_cat, 
      ...
      final_toy_type ~ social_condition * goal_condition,
