...
exp = {
    ...
    hypotheses_slide: function () {
        ...
        if (exp.hyp_type == "posterior") {
            ...
            hyp_text_html = "After performing your action, how likely do you think the toy with the missing label is ..."
        } else if (exp.hyp_type == "prior") {
            hyp_text_html = "Imagine that one of your toys was missing its label. <br><br> How likely do you think this toy is ..."
        ...
        for (i = 0; i < rand_slider_labels.length; i++) {
            ...
            if (toy_label.includes("Both")) {
                slider_html = `<td align="right"><img src="imgs/` + hypotheses_slider_labels[2] + `.jpeg" height="180" width="240" align="center"></td>` +
//    `<td><b>` + hypotheses_slider_labels[2] + ` toy</b></td>`
            `<td>
             <div id="slidecontainer">
                ...
                slider_html = `<td align="right"><img src="imgs/` + hypotheses_slider_labels[0] + `.jpeg" height="180" width="240" align="center"></td>` +
//                    `<td><b>` + hypotheses_slider_labels[0] + ` toy</b></td>
    		`<td>
    			<div id="slidecontainer">
                ...
                slider_html = `<td align="right"><img src="imgs/` + hypotheses_slider_labels[1] + `.jpeg" height="180" width="240" align="center"></td>` +
//                    `<td><b>` + hypotheses_slider_labels[1] + ` toy</b></td>
    		`<td>
    			<div id="slidecontainer">
    				<input type="range" min="1" max="100" value="50" class="slider" id="myRange1">
    			</div>
