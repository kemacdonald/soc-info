...
exp = {
        ...
        toy_instructions_slide: function () {
            ...
            toys_inst = {
                ButtonMusic: "<b>ButtonMusic toy</b>: Press the button on the left to play music. Pull the handle on the right to turn on the light.",
                HandleMusic: "<b>HandleMusic toy</b>: Pull the handle on the right to play music. Press the button on the left to turn on the light.",
                BothMusicLight: "<b>BothMusicLight toy</b>: Pull the handle on the right AND press the button on the left to turn on the light and play music. The button press or handle pull on its own doesn’t produce any effect.",
            };
...
'<img src="imgs/' + toys_not_both[0] + '.jpeg" height="200" width="300">' +
                    ...
                    $(`#music_box_instructions`).html(
                                            '<p class="action-text">These are the instructions for <b>the '+toys_not_both[1]+'</b> toy.</p>' +       
