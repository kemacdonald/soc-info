...
if (goal_condition == "learning" && outcome == "light") {
    ...
    goal_text_html2 = `Imagine that your boss was looking somewhere else when you acted on the toy, so you actually get another chance to try an action on the toy. Which action would you want to take? <b>Remember, you will get a ${bonus_amount} bonus after submitting the HIT if you correctly figure out which toy this is</b>.`
...
`
    goal_text_html2 = `Imagine that your boss was looking somewhere else when you acted on the toy, so you actually get another chance to try an action on the toy. Which action would you want to take? <b>Remember, you will get a ${bonus_amount} bonus if the light turns on</b>.`
...
`
    goal_text_html2 = `Imagine that your boss was looking somewhere else when you acted on the toy, so you actually get another chance to try an action on the toy. Which action would you want to take? <b>Remember, you will get a ${bonus_amount} bonus if the toy plays music</b>.
`
...
`
    goal_text_html2 = `Imagine that your boss was looking somewhere else when you acted on the toy, so you actually get another chance to try an action on the toy. Which action would you want to take? <b>Remember, you will get a ${bonus_amount} bonus for impressing your boss</b>.
`
} else if (goal_condition == "noGoal") {
    goal_text_html = `One day you see one of these toys lying on the ground. <br><br>Unfortunately, you were in a rush when you built this particular toy and forgot to label it. <br><br>If you only had <b>one chance to play with this toy</b>, which action would you want to take?
`
    goal_text_html2 = `Imagine that you get another chance to try an action on the toy. Which action would you want to take?
`
}
