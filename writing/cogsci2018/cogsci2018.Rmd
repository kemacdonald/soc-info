...
```{r image, fig.env = "figure", fig.pos = "b", fig.align='center', fig.width=2, fig.height=2, set.cap.width=T, num.cols.cap=1, fig.cap = "An example of the toy used in our paradigm."}
...
To examine the learning-performance tradeoff, 
...
We proposed that people make decisions based on a principled tradeoff between learning- and performance-oriented goals, 
