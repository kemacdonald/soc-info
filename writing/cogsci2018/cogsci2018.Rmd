...
or to present himself as competent and knowledgeable about how the toy works (*presentational utility*; see Fig \ref{fig:model_diagram}).
...
When there is another person present to observe the learner's action, the observer $O$ is expected to reason about the learner $L$'s competence $c$, equal to whether the learner was able to make the toy produce an effect.
