...
We modeled change in entropy (see Panel C of Fig 2) as a function of goal condition and participants' action selections: \texttt{$entropy\_change \sim goal\_condition + action\_response$}. Across all conditions, people who selected the single action showed a greater reduction in entropy ($\beta$ = `r e1_contrasts_ent$ent_change[4]`, [`r e1_contrasts_ent$hdi_lower[4]`, `r e1_contrasts_ent$hdi_upper[4]`]. We did not see evidence of an interaction between goal condition and action selection. However, recall that a larger proportion of participants selected the single action in the Learning condition, so the probability of learning is likely to be greater in this context.  
