...
that will each lead to one outcome (new discovery) or the other (overt reward) with certainty.
The learner's action rests on his goals to explore versus exploit, 
and is determined in part by the presence or absence of another person he cares about (i.e. his boss)\footnote{From here on, we use a male pronoun for Bob, the learner, and female pronoun for Ann, the observer.}.
