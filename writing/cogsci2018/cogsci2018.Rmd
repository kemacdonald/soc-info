...
We model a learner $L$ who chooses his action $a$ approximately optimally (as per optimality parameter $\lambda$) based on the expected total utility $U_{t}$ given his action and presence of an observer $o$:
...
The learning utility in our model is derived from Optimal Experiment Design models [OED; @nelson2005], 
...
This decrease is captured by *information gain* due to an action, the change in the learner’s entropy (uncertainty) before and after seeing an outcome. 
...
Once the learner chooses an action and observes an outcome, 
