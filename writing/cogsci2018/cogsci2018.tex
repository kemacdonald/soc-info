...
(``Optimal Experiment Design''; Nelson, 2005), which quantifies the
...
{\centering \includegraphics[width=0.98\linewidth]{figs/e2_results-1} 
...
\vspace{1em}
\fbox{\parbox[b][][c]{7.3cm}{\centering All experiments, data, model, and analysis codes are in the online repository for this project: \url{https://github.com/kemacdonald/soc-info}}}
\vspace{1em} \noindent
