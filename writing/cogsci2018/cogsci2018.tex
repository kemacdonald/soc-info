...
On average, participants took 27.82 seconds to generate a response in
the No-goal condidition. Participants took on on average 1.48 seconds
longer to generate a decision in the Learning condition (\(\beta\) =
0.39, {[}1.15, 1.88{]}) but produced similar response times in the
Performance (\(\beta\) = -0.15, {[}0.66, 1.11{]}) and Presentation
(\(\beta\) = -0.11, {[}1.15, 1.14{]}) conditions.
