...
\begin{CodeChunk}
\captionsetup{width=0.8\textwidth}\begin{figure*}[tb]
...
individual whom he wants to impress). We look at adult participants'
action choices within a minimalistic self-directed learning task
representing different goals and social contexts in two experiments, and
show that people's choices are consistent with predictions of our model.
...
(\(\beta =\) -52.1\%, {[}-100.5\%, -5.3\%{]}). Finally, there was
